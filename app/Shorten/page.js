  ...
  return (
    ...
    <div className=" mx-auto max-w-lg bg-purple-100 my-16 p-8 rounded-lg flex flex-col gap-4 text-black ">
      ...
      <div className='flex flex-col gap-2'>
                <input type="text"
                    value={url}
                    className='px-4 py-2 focus:outline-purple-600 rounded-md border border-r-purple-800'
                    placeholder='Enter your URL'
                    onChange={e => { seturl(e.target.value) }} />  
                
                <input type="text"
                    value={shorturl}
                    className='px-4 py-2 focus:outline-purple-600 rounded-md border border-purple-800'
